    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between pb-3 px-3 gap-2">
          <label
            htmlFor="file"
            className="border border-white/10 text-white/80 hover:text-white hover:border-white/40 p-1.5 rounded-md cursor-pointer flex items-center justify-center"
          >

    ...
    <div className='absolute inset-0 bg-zinc-950/40 backdrop-blur-xs flex items-center justify-center z-50'>
        <div className='bg-white border border-zinc-200 shadow-lg rounded-xl max-w-md w-full p-6 mx-4 relative'>
            ...
            <div>
                ...
                <p className='text-sm text-zinc-500'>Anyone with this link below can view your published site.</p>
            </div>
            <div>
                <div>
                    <label className='block text-[10px] font-semibold text-zinc-400 uppercase tracking-widest  mt-5'>
                        Published Link
                    </label>
                ...
                <div className='flex gap-2 pt-2'>
                    ...
                    <button onClick={()=> window.open(publishUrl, "_blank")} className='flex-1 py-2 border border-zinc-200 text-zinc-700 text-xs font-medium hover:bg-zinc-50 cursor-pointer rounded-lg text-center'>Open Site</button>
                </div>
            </div>
        </div>
    </div>
